...
<li><b>강력한 데이터 접근 제어:</b> 주민등록번호와 같은 민감 개인정보는 클라우드 서버 전송 과정에서 강력한 외부 암호화 통신(SSL/TLS)을 따르며, 구글 데이터센터에 보관되는 즉시 저장소 단위에서 암호화됩니다. 추가로 기관 코드를 통해서만 해당 자료를 열람할 수 있도록 다중 인증 및 방화벽 설계가 적용되어 안전합니다.</li>
</ul>
""",
    "2. 강사 개별 및 엑셀 일괄 등록": """
<h2>강사 정보 등록 가이드</h2>
